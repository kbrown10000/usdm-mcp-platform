@echo off
echo Setting up Railway deployment for USDM MCP Platform V27.0

set RAILWAY_TOKEN=9ef48cd3-bb8a-4df2-b1e8-97003b2ffeb7

echo Linking to Railway project...
railway link --project 38d862fb-96c3-4078-96f7-12364ed57c4f
...
echo View at: https://railway.app/project/38d862fb-96c3-4078-96f7-12364ed57c4f
pause